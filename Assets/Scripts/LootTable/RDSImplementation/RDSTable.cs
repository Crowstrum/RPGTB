...
namespace rds
{
		...
		public class RDSTable : IRDSTable
		{
           ...
           #region EVENTS
				...
				{
						if (rdsPreResultEvaluation != null)
								rdsPreResultEvaluation (this, e);
				}
				/// <summary>
				...
				{
						if (rdsPostResultEvaluation != null)
								rdsPostResultEvaluation (this, e);
				}
           #endregion
          ...
          #region RESULT
				...
				public virtual IEnumerable<IRDSObject> rdsResult {
						get {
								...
								// is set in the table! If there are 5 objects "always" 5, those  will
          ...
          #region TOSTRING
				...
				/// Returns a <see cref="System.String"/> that represents this instance.
				/// </summary>
				/// <param name="indentationlevel">The indentationlevel.  blanks at the beginning of each line for each level.</param>
				/// <returns>
				/// A <see cref="System.String"/> that represents this instance.
				/// </returns>
				public string ToString (int indentationlevel)
				{
						...
						sb.AppendFormat (indent + "(RDSTable){0} Entries:{},Prob:{2},UAE:{3}{4}{5}{6}", 
                  this.GetType ().Name, mcontents.Count, rdsProbability,
                  (rdsUnique ? "" : "0"), (rdsAlways ? "" : "0"), (rdsEnabled ? "" : "0"), (mcontents.Count > 0 ? "\r\n" : ""));
  
						foreach (IRDSObject o in mcontents)
								sb.AppendLine (indent + o.ToString (indentationlevel + 3));
